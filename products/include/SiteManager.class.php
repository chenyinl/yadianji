...
class SiteManager
{
	...
	function LoadTemplate()
	{
		...
		{
			$this->TemplateHTML = str_replace('<a href="http://www.atnsolutions.com','<a rel="nofollow" href="http://www.atnsolutions.com',$this->TemplateHTML);
		}
	...
	function load_login_slides($product="")
	{
		...
		$url = "http://www.atnsolutions.com/get_slides.php";		
